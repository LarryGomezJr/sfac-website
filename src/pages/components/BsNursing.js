...
const BsNursing = () => {
  return (
    ...
    <figure >
     <Image className="items-center justify-center flex-col container-fluid bg-primary py-5 mb-5 hero-header transition-all duration-300 cursor-pointer " src={Copy2} width={10000} height={10000} alt="image description"/>
