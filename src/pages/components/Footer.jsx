...
const Footer = () => {
  return (
    <footer className="text-gray-600 body-font drop-shadow-2xl ">
      <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col sm:flex-nowrap flex-wrap flex-col">
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
          <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            <Image src={logo} alt="sfac logo" width={40} height={40} />
            <span className="ml-3 text-xl text-red-600">SFAC Las Piñas</span>
          </a>
        ...
        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
          ...
          <p className="text-gray-500 text-sm mt-2 md:text-left text-center">
            ...
            <br className="lg:block hidden" waistcoat green />
          </p>
        </div>
        <div className="flex-grow flex flex-row-reverse md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">
              CATEGORIES
            </h2>
