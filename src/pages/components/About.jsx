      ...
      <div class="p-4 md:w-1/3">
        <div class="flex rounded-lg h-full bg-gray-100 border border-red-500 p-8 flex-col">
          ...
          <div class="flex-grow">
            ...
            <div class="flex-grow text-gray-900 text-justify text-lg title-font font-sm">1. Deliver relevant, well-designed quality education from the Basic Education to the Graduate level, through its corps of highly-trained faculty.</div>
            <div class="flex-grow text-gray-900 text-justify text-lg title-font font-sm">2. Nurture an ideal environment that hones students for academic success, molds them in cultural awareness, and prepares them for sustained participation and leadership in sports and athletics.</div>
            <div class="flex-grow text-gray-900 text-justify text-lg title-font font-sm">3. Incorporate a values system in the curriculum that promotes love of God, family, and country.</div>
            <div class="flex-grow text-gray-900 text-justify text-lg title-font font-sm ">4. Integrate time-honored Filipino values in the pursuit of personal advancement.</div>
      ...
      <div class="p-4 md:w-1/3">
        <div class="flex rounded-lg h-full bg-gray-100 border border-red-500 p-8 flex-col">
          ...
          <div class="flex-grow ">
            ...
            <div class="flex-grow text-gray-900 leading-relaxed text-base">
